switchTheme = () => {
    ...
    let text = document.querySelectorAll('.main__button, .tab__button, .footer__text, .main__fact, .fact__strong, .header__subheading, .header__icon')
    let buttons = document.querySelectorAll('.main__button--white, .tabs__buttons-container, .tab__button')
