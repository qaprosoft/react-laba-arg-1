...
function PaginationHelper(collection, itemsPerPage){
    ...
    PaginationHelper.prototype.pageIndex = function(itemIndex) {
        if (itemIndex < 0 || itemIndex > this.items.length || this.items.length == 0){ return (-1);}
        return Math.floor( itemIndex / this.itemsPerPage);
    }

    //this kata passes all test but one in "attempt" but as it does not show tests, I can't figure out why it fails and fix it
